      ...
      <div className='xl:mt-8 flex flex-grow xl:flex-col xl:max-h-screen justify-around xl:justify-start mx-auto'>
        <Link to='/'>
          <div className='py-8 flex items-center flex-col xl:flex-row'>
            <svg xmlns='http://www.w3.org/2000/svg' className='xl:ml-4 xl:ml-0 h-4 w-4 xl:h-12 xl:w-12' fill='none' viewBox='0 0 24 24' stroke='currentColor'>
              <path strokeLinecap='round' strokeLinejoin='round' strokeWidth='2' d='M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6' />
            </svg>
            <div className='xl:ml-4 text-xs xl:text-2xl font-bold'>Home</div>
          </div>
        </Link>
        ...
        <Link to='/about'>
          <div className='py-8 flex items-center flex-col xl:flex-row'>
            ...
            <div className='xl:ml-4 text-xs xl:text-2xl font-bold'>About</div>
          </div>
        </Link>
        ...
        <Link to='/vault'>
          <div className='py-8 flex items-center flex-col xl:flex-row'>
            ...
            <div className='xl:ml-4 text-xs xl:text-2xl font-bold'>Vault</div>
          </div>
        </Link>
        ...
        <Link to='/dashboard'>
          <div className='py-8 flex items-center flex-col xl:flex-row'>
            ...
            <div className='xl:ml-4 text-xs xl:text-2xl font-bold'>Dashboard</div>
          </div>
        </Link>
        ...
        <Link to='/community'>
          <div className='py-8 flex items-center flex-col xl:flex-row'>
            ...
            <div className='xl:ml-4 text-xs xl:text-2xl font-bold'>Community</div>
          </div>
        </Link>
      </div>
    </nav>
