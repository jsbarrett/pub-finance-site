...
export const getMarketCap = async () => {
  ...
  const w3 = new Web3(new Web3.providers.HttpProvider(infuraEndpoint))
  ...
  const totalSupply = new BigNumber('10000000000000000000000000')
...
export const getTotalValueLockedCardData = async () => {
...
export const getOtherCardData = async () => {
